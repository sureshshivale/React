...
public class CabDaoImpl implements CabDaoIface {
	...
	public boolean isAdminUpdate(String userid, String adminid)
	{
		try
		{
			...
			/*Query query1 =entitymanager.createQuery("INSERT INTO UserProfile OPEN (userId,userName,userPhone,userEmail) VALUES(arg1,arg2,arg3,arg3)",UserProfile.class);
			query1.setParameter("arg1", adminid);
			query1.setParameter("arg2", "admin");
			query1.setParameter("arg3", null);*/			
			
			/*int query2=entitymanager.createNativeQuery("INSERT INTO UserProfile (userId,userName,userPhone,userEmail) VALUES (?,?,?,?)").setParameter(1, adminid).setParameter(2, "admin").setParameter(3, null).setParameter(4, null).executeUpdate();
			query2.setParameter("arg1", adminid);
			query2.setParameter("arg2", "admin");
			query2.setParameter("arg3", null);		
			System.out.println("********************************************************"+query2);
			return true;*/
				UserProfile newAdmin=new UserProfile();
				newAdmin.setUserId(adminid);
				newAdmin.setUserName("admin");
				newAdmin.setUserPhone(null);
				newAdmin.setUserEmail(null);
			entitymanager.persist(newAdmin);
			entitymanager.flush();
			return true;

    ...
    <div class="col-sm-8 col-md-12 main">	   
	   <div id="page-wrapper">
		<div id="page-inner">
                    ...
                    <div class="panel panel-primary"  style="height:480px;width:900px;margin-left:210px">
                        <div class="panel-heading">
                            ...
                            <ul class="nav nav-tabs">
                            	<li class="active"><a href="#settings" data-toggle="tab">Update Profile</a>
                                </li>                              	
                                <%                      
                                	 if(AdminCheck.equals("ADMIN"))
                                	 {
                                 %>                               
                                <li class=""><a href="#home" data-toggle="tab">Add Cab</a>
                                </li>                                                           
						...
						<br/>
						  <table>
							<tbody>
									...
									<tr>
									<tr>
									<td><b>Associate Email Id</b></td>
										<td>&nbsp;</td>
										<td><b>:</b></td>
										<td>&nbsp;&nbsp;</td>
									<td><input type="text" name="emailid" placeholder="Your Email Id" class="form-control input"></td>		
									<td><span style="color:red"  id="emailloc"></span></td>							
									</tr>
									<tr>
										<td>&nbsp;</td>
										<td>&nbsp;</td>
									</tr>
									<td><b>Associate Contact Number</b></td>
										<td>&nbsp;</td>
										<td><b>:</b></td>
										<td>&nbsp;&nbsp;</td>
			...
			<br/><br/><br/><br/><br/><br/>
			<input type="submit" value="Change" class="btn btn-primary" onclick="submitSettingsForm('updatecontact')" onsubmit="return validatecontact()">
			...
			<input type="reset" value="Cancel" class="btn btn-primary" onclick="window.location.href='Home.jsp'">
			<br/><br/>
			<b><font color="red">Note:Session will be automatically logged out once the admin id gets updated.Please relogin for the changes to persist.</font></b>
			</div>
